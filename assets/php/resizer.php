...
define ('FILE_CACHE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'] . '/assets/images/optimized/');			// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
